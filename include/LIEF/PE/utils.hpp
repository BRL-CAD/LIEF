...
/// IMPHASH_MODE::PEFILE as second parameter.
///
/// @warning The default algorithm used to compute the *imphash* value has some
/// variations compared to Yara, pefile, VT implementation
///
/// @see
...
/// resolved
/// @param[in] use_std If ``true``, it will use the
/// [pefile](https://github.com/erocarrera/pefile/tree/09264be6f731bf8578aee8638cc4046154e03abf/ordlookup)
/// look-up table for resolving imports
///
/// @return The PE::import resolved with PE::ImportEntry::name set
LIEF_API result<Import> resolve_ordinals(const Import& import, bool strict = false,
                                         bool use_std = false);
